...
#import "GJTabBar.h"
#define GJTABBARCONTROLLER ((GJTabBarController *)self.tabBarController)
/**
 *  README
...
/** 自定义的tabbar */
@property (strong , nonatomic) GJTabBar* tabbar;
 ...
 */
- (void)setGJTabBarHidden:(BOOL)hidden animated:(BOOL)animated;
